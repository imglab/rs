...
<div class="container">
	<div class="columns">
		<div class="column col-6">
			...
			<h4>Créditos</h4>
			<p>Este site foi desenvolvido com Svelte e Spectre.css, com o apoio técnico de Emmanuel Château-Dutier e <a href="https://github.com/WilliamDiakite">William Diakité</a>. As visualizações de rede utilizam Cytoscape.js. Todo o conteúdo do site <a href="/">Réseaux Sensibles</a> é de propriedade de Talitha Motter e está protegido por leis de direito autorais brasileiras e internacionais.</p>
		</div>
