...
<script>
	...
	import { networks }  from '$lib/revistaDesvioRef/networks'
	import { styles }  from '$lib/revistaDesvioRef/styles'
	...
	var cy = cytoscape({
			...
			elements: networks["rsArtistRefTextByPublicationreRevistaDesvio.xml"].elements,
...
<p>Rede unimodal dos 322 artistas-referenciados das críticas publicadas pela <a href="https://web.archive.org/web/20230129220351/https://revistadesvio.com/">Revista Desvio</a> até abril de 2019. Última atualização: 20/01/2024</p>
<div id="cy"/>
