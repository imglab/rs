...
<script>
	...
	import { networks }  from '$lib/arteContextoRef/networks'
	import { styles }  from '$lib/arteContextoRef/styles'
	...
	var cy = cytoscape({
			...
			elements: networks["rsArtistRefTextByPublicationreArteContexto.xml"].elements,
...
<ul class="breadcrumb">
	...
	<li class="breadcrumb-item">
		<a href="/reseaux/reseauRefArteContexto" class="btn btn-link">Artistas-Tema - Arte ConTexto</a>
	</li>
</ul>

<h2>Artistas-Referência - Arte ConTexto</h2>
<p>Rede unimodal dos 153 artistas-referência das críticas publicadas pela <a href="https://artcontexto.com.br/">Arte ConTexto</a> até abril de 2019. Última atualização: 03/01/2024</p>
<div id="cy"/>
