...
<script>
	...
	import { networks }  from '$lib/arteContextoEIC/networks'
	import { styles }  from '$lib/arteContextoEIC/styles'
	...
	var cy = cytoscape({
			...
			elements: networks["rsArtistTermAuthorByPublicationreArteContexto.xml"].elements,
...
<svelte:head>
	<title>Artistas-temas - Arte ConTexto - EIC</title>
</svelte:head>
...
<p>Rede unimodal dos(as) 69 artistas-tema das críticas publicadas pela <a href="https://artcontexto.com.br/">Arte ConTexto</a> até abril de 2019. Em verde, os(as) artistas que foram identificados na busca da <a href="https://enciclopedia.itaucultural.org.br/">Enciclopédia Itaú Cultural</a>. Última atualização: 02/2024</p>
