...
<script>
	...
	import { networks }  from '$lib/performatusEIC/networks'
	import { styles }  from '$lib/performatusEIC/styles'
...
<svelte:head>
	<title>Artistas-temas - Revista Performatus - EIC</title>
</svelte:head>
...
<p>Rede unimodal dos(as) 147 artistas-tema das críticas publicadas pela <a href="https://performatus.com.br/">eRevista Performatus</a> até abril de 2019. Em verde, os artistas que foram identificados na busca da <a href="https://enciclopedia.itaucultural.org.br/">Enciclopédia Itaú Cultural</a>. Última atualização: 02/2024</p>
<div id="cy"/>
