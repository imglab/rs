...
<div class="container">
	<div class="columns">
		<div class="column col-6">
			<p>Focando na ideia que uma crítica de arte permite relacionar diferentes artistas no intuito de formar a argumentação apresentada por seu(sua) autor(a) ou autores(as), as presentes redes revelam o conjunto de artistas referenciados(as) pelos textos do corpus de cada uma das cinco revistas estudadas. A ligação entre dois(duas) artistas é formada pelo fato de eles(elas) terem sido mencionados/referenciados pelo texto, sem necessariamente terem assumido o papel de tema do texto em questão (artistas-tema). Isso permite verificar como o conjunto de artistas-referenciados por cada revista se conecta dentro da série de críticas que foi levantada na pesquisa de doutorado Réseaux sensibles.</p>
		...
		<div class="column col-5">
			<h4>Acesse as redes de Artistas-referenciados</h4>
			<ul>
